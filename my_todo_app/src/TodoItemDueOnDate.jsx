...
function TodoItemDueOnDate({todo, toggleTodo, enableEditing, enableCategoryDropdown, saveTitle, saveCategory, isEditing, isEditingCategory}) {
    ...
    export default TodoItemDueOnDate;